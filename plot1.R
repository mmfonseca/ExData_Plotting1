## plot1.R script
## this script contains the code used to plot plot1.png 
...
## making plot 1
## Description:
## An histogram of the frequency of the Global Active Power 

## initiate png file to store plot1
png(filename = "plot1.png",width = 480, height = 480)
        hist(mydataset$Global_active_power, col = "red", main = "Global Active Power",
